...
#first parameter represents the HR and the second parameter represents the LR
# parameters:
K <- c(10^9,10^7) # carrying capacity 
A <-c(1.01,1.01) # antibiotic concentration
...
example_figure<-ggplot(S_together) +
